...
//const productsCollection = new Datastore({ filename: __dirname + '/products', autoload: true }); -läsa från fil istället

module.exports = {customersCollection, ordersCollection};